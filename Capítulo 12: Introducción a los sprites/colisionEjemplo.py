...
class Bloque(pygame.sprite.Sprite):
    ...
    def __init__(self, color, width, height):
        ...
        self.image = pygame.Surface([width, height]) # Dibuja el rectángulo o cuadrado, será de color negro
        self.image.fill(color) # Pinta la superficie con un color sólido
        ...
        self.rect = self.image.get_rect() # Extracción del rectángulo que se mueve
    ...
    def reset_pos(self):
        ...
        """
        self.rect.y = random.randrange(-300, -20) # random.randrange(inicio,final + 1)
        self.rect.x = random.randrange(700-20) # random.randrange(stop) => 0 a stop - 1
...
for i in range(50):
    ...
    bloque.rect.x = random.randrange(largo_pantalla-20)
...
while not hecho:
    ...
    lista_impactos_bloques = pygame.sprite.spritecollide(protagonista, bloque_lista, False) # Con True, todos los sprites que colisionan se removerán de la lista. Retorna una lista
