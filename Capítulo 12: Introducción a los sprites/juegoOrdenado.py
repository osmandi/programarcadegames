...
class Bloque(pygame.sprite.Sprite):
    ...
    def reset_pos(self):
        ...
        self.rect.x = random.randrange(LARGO_PANTALLA - 20)
...
class Juego(object): # Object es una variable especial en python que se utiliza de herencia cuando creamos una nueva clase en python 2 pero no es necesario para python 3
    ...
    # Lista de sprites, no son necesarios declararlos
    bloque_lista = None
    ...
    def procesos_de_eventos(self):
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.MOUSEBUTTONDOWN:
                if self.game_over:
                    self.__init__() # Reinicia el juego desde el constructor en la función
    ...
    def logica_de_ejecucion(self):
        ...
        if not self.game_over:
            ...
            lista_impactos_bloques = pygame.sprite.spritecollide(self.protagonista, self.bloque_lista, True) # Elimina el bloque de la lista al impactar
    ...
    def display_frame(self, pantalla):
        ...
        if self.game_over:
            ...
            centrar_x = (LARGO_PANTALLA // 2) - (texto.get_width() // 2) # Cociente entero
...
def main():
    ...
    pygame.mouse.set_visible(False) # Ocultar el mouse
    ...
    while not hecho:
        ...
        hecho = juego.procesos_de_eventos()
