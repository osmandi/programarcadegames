...
def imprimir_instrucciones():
    ...
    # En una declaración print, puedes usar comillas triples para imprimir varias líneas.
    print("""
...
def obtener_datosdel_usuario(nombre):
    ...
    números. """
    # Más adelante, en el capítulo sobre 'excepciones', aprenderemos como modificar este código para que no se
    # cuelgue cuando el usuario escriba algo que no sea un número válido.
