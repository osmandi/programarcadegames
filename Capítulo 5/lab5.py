...
while not hecho:
    ...
    #Al quitar el número de píxeles en las figuras, se dibuja en todo el fondo
    pygame.draw.rect(pantalla, NEGRO, [20, 20, 250, 100])

    # Dibujamos una elipse, usando un rectángulo para fijar sus bordes exteriores
    pygame.draw.ellipse(pantalla, AZUL, [20, 20, 250, 100])
