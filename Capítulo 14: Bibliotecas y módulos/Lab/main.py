...
from funcion_bloquebueno import *
from funcion_bloquemalo import *
from rectangulo_saltarin import *
...
class Juego():
    ...
    def __init__(self):
        ...
        for i in range(80):
            ...
            bloque = BloqueBueno(VERDE, 20, 15)
        ...
        # Bloques de sprites saltarin malo
        for i in range(10):

            bloque = RectanguloSaltarin(OTRO, 20, 15)
